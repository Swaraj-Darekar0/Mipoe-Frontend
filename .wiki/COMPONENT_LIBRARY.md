...
- **BrandOnboarding (`BrandOnboarding.tsx`)**: Standalone multi-step wizard containing form inputs, disabled/locked states on PAN verification success, a glassmorphic blurry overlay (`backdrop-blur-[4px] bg-white/60`), and a manual override Edit toggle to rewrite details.
