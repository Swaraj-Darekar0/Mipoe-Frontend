...
const PersonaNavbar: React.FC = () => {
  ...
  return (
    ...
    <div className="sticky top-0 md:top-4 z-50 w-full px-0 md:px-6">
      <nav className="mx-auto max-w-7xl flex items-center justify-between gap-4 border-b md:border border-hairline bg-canvas/95 backdrop-blur-sm md:rounded-2xl md:shadow-[0_1px_2px_rgba(15,15,15,0.04)] px-4 md:px-6 h-16">
        <a href="#" className="font-semibold text-[18px] leading-none text-ink-deep shrink-0 whitespace-nowrap">
          sellr.
        </a>
        ...
        <button
          ...
          className="shrink-0 whitespace-nowrap inline-flex items-center gap-1.5 rounded-full bg-ink-deep px-4 py-2 text-[13px] font-semibold text-black hover:bg-charcoal transition-colors"
        >
          For {content.toggleLabel} →
        </button>
      </nav>
    </div>
  );
