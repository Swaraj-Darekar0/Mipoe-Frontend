...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 z-40 w-full grid-border backdrop-blur-md bg-white/70 dark:bg-black/70 px-4 md:px-8 py-3 text-xs uppercase tracking-widest text-dark-void dark:text-snow flex justify-between items-center transition-all duration-300">
